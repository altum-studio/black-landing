...
| SEO/AEO: SPA sin contenido en el HTML crudo (invisible para rastreadores de IA y lento de indexar), título sin keyword, H1 sin "locales comerciales", sin datos estructurados, sin FAQ, sin robots/sitemap | 3 | Pre-render en build + hidratación; título "Locales comerciales en pozo en Escobar \| BLACK…"; kicker dentro del H1; JSON-LD ShoppingCenter + WebSite + FAQPage; sección FAQ con 6 respuestas directas; robots.txt y sitemap.xml; lang es-AR; geo tags | done |
