...
├── components/Brand.tsx  # Logo, LogoTiles, GrupoBlack, Pattern, PatternImage, Button, Section, Title
...
public/img/               # renders web (1800px, jpg) tomados de Drive › Grupo BLACK › 01_PRODUCCION_VISUAL › Renders_Finales
```
